...
<body>
	...
	<div class="hero page-inner overlay" style="background-image: url('images/tourbg.jpg');">

		<div class="container">
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-9 text-center mt-5">
					<h1 class="heading" data-aos="fade-up">Tour Packages</h1>

					<nav aria-label="breadcrumb" data-aos="fade-up" data-aos-delay="200">
						<ol class="breadcrumb text-center justify-content-center">
							<li class="breadcrumb-item "><a href="home">Home</a></li>
							<li class="breadcrumb-item active text-white-50" aria-current="page">Tour Packages</li>
						</ol>
					</nav>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
					...
					<a href="" class="img">
									<img src="images/semarangb.jpg" alt="Image" class="img-fluid">
								</a>

								<div class="property-content">
									<div class="price mb-2"><span>Rp 775.000 /pax </span></div>
									<div>
										<span class="d-block mb-2 text-black-50"></span>
										<span class="city d-block mb-3">Semarang B</span>
										<span class="city d-block mb-3"></span>
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
					...
					<a href="" class="img">
									<img src="images/malangb.jpg" alt="Image" class="img-fluid">
								</a>

								<div class="property-content">
									<div class="price mb-2"><span>Rp 550.000 /pax </span></div>
									<div>
										<span class="d-block mb-2 text-black-50"></span>
										<span class="city d-block mb-3">Malang B</span>
										<span class="city d-block mb-3"></span>
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
					...
					<a href="" class="img">
									<img src="images/balib.jpg" alt="Image" class="img-fluid">
								</a>

								<div class="property-content">
									<div class="price mb-2"><span>Rp 1.150.000 /pax </span></div>
									<div>
										<span class="d-block mb-2 text-black-50"></span>
										<span class="city d-block mb-3">Bali B</span>
										<span class="city d-block mb-3"></span>
