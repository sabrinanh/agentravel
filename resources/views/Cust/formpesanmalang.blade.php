		...
		<div class="container">
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-9 text-center mt-5">
					<h1 class="heading" data-aos="fade-up">Malang Tour Packages</h1>
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" id="formGroupExampleInput2">
      ...
      <!-- </div>
      <a href="id=panelsStayOpen-headingTwo" class="btn btn-primary gap-2 col-5 mx-auto1">Tambah Peserta</a>
    </div> -->

    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#panelsStayOpen-headingTwo">
  Launch demo modal
</button>
