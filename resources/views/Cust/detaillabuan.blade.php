		...
		<div class="container">
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-9 text-center mt-5">
					<h1 class="heading" data-aos="fade-up">Labuan Bajo Tour Package</h1>

					<nav aria-label="breadcrumb" data-aos="fade-up" data-aos-delay="200">
						<ol class="breadcrumb text-center justify-content-center">
							<li class="breadcrumb-item "><a href="home">Home</a></li>
							<li class="breadcrumb-item "><a href="tourpackages">Tour Packages</a></li>
							<li class="breadcrumb-item active text-white-50" aria-current="page">Labuan Bajo Tour Package</li>
						</ol>
					</nav>
		...
		<div class="container">
			<div class="row justify-content-between">
				...
				<div class="col-lg-5">
					...
					<p class="text-black-30">1. Bukit Sylvia</p>
					<p class="text-black-30">2. Pulau Padar</p>
					...
					<a href="infolabuan" class="btn btn-primary py-2 px-3">Pesan</a>
