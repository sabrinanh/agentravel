    ...
    <div class="container-justify">
            ...
            <div class="col-lg-10" >
                <div class="card1 card-margin">
                    <div class="card-header no-border">
                        <h4><b class="card-title"><b>Bali Tour Package</b></h4></b>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-10" >
                <div class="card1 card-margin">
                    <div class="card-header no-border">
                        <h4 class="card-title"><b>Pack (Bali Tour Package)</b></h4>
                    </div>
                    <div class="card-body pt-0">
                        <div class="widget-49 widget-49-meeting-points">
                                <p class="widget-49-meeting-item "><b><span>Rp960.000</b></span></p>
...
<div class="container">
	<div class="row">
                	...
                	<div class="row">
                    <div class="col-lg-6">
                    <a href="formpesanBaliA" class="btn btn-primary ">Pesan</a>
    ...
    <!-- <div class="container-justify-text-center">
        <div class="row">
            <div class="col-md-12" >
                <div class="card1 card-margin">
                    <div class="card-header no-border">
                        <h4 class="card-title">Pack (Bali Tour Package)</h4>
                    </div>
                    <div class="card-body pt-0">
                    <div class="widget-49 widget-49-meeting-points">
