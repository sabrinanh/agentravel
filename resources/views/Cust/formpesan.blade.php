...
<main id = "main"class="main">
    ...
    <div class="container px-4 px-lg-5">
        ...
        <form action="/pembayaran" method="post">
            ...
            <input type="text" class="form-control" id="formGroupExampleInput2" name="NIK">
            </div>
            <div class="mb-3">
            <label for="formGroupExampleInput2" class="form-label">No.Telp</label>
            <input type="text" class="form-control" id="formGroupExampleInput2" name="notelp">
            </div>
            <div class="mb-3">
            ...
            <input type="email" class="form-control" id="formGroupExampleInput2" name="email">
                ...
                <a class="btn btn-primary gap-2 col-5 mx-auto3">Pesan</a>
        </form>
    </div>
  </div>
</div>
